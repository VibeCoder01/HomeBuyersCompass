...
export const glossaryData = [
  ...
  {
    term: 'Conveyancing',
    definition: `The essential legal work to transfer property ownership. A solicitor or licensed conveyancer does this. They handle contracts, searches, and the movement of money. MUST KNOW: Choose your conveyancer early to avoid delays. Look for firms accredited under the <a href="https://www.lawsociety.org.uk/for-the-public/using-a-solicitor/quality-marks/conveyancing-quality-scheme/" target="_blank" rel="noopener noreferrer">Law Society's Conveyancing Quality Scheme (CQS)</a>.`,
  },
  {
  ...
  {
    term: 'Title Deeds',
    definition: `Legal documents proving ownership. Most are now digital, held by HM Land Registry. The "Title Information Document" and "Title Plan" are the modern equivalent, showing the owner and any mortgage charges. You can learn more at the <a href="https://www.gov.uk/government/publications/official-copies-of-register-or-plan-registration-oc1" target="_blank" rel="noopener noreferrer">HM Land Registry</a> website.`,
  },
];
